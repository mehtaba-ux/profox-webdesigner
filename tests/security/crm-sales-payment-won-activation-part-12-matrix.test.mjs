...
const cases = [
  ...
  ['40 Commission created once', () => /generate_commission_for_verified_payment/.test(verify) && /commission_entries_payment_id_key/.test(corpus)],
  ...
  ['42 Project created once', () => /create_project_from_sale/.test(verify) && /projects_source_opportunity_id_key/.test(corpus)],
  ...
  ['47 onboarding initializes once', () => /client_onboardings_project_id_key/.test(corpus) && /ensure_client_onboarding_for_project/.test(corpus)],
  ...
  ['66 duplicate Admin verification does not duplicate activation', () => /if v_payment\.status='Verified' then/.test(verify) && /commission_entries_payment_id_key/.test(corpus) && /projects_source_opportunity_id_key/.test(corpus)],
