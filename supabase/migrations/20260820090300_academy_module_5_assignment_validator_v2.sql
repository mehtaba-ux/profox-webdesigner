-- The pre-existing assignment validator expected the legacy five-prospect payload.
-- Module 5 v2 performs its deep validation inside submit_lead_research_assignment.
