...
function QualityMetricCard({ metric }: { metric: SalesPerformanceQualityMetric }) {
  ...
  return <div className="rounded-2xl border border-slate-200 bg-white p-4">
    <div className="flex items-start justify-between gap-3">
      <div className="min-w-0"><div data-testid={`part15-quality-metric-${metric.key}`} className="text-[10px] font-black uppercase tracking-wide text-slate-400">{metric.label}</div><div className="mt-1 text-lg font-black text-slate-900">{metricDisplay(metric)}</div></div>
