      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button 
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[#000080] hover:bg-[#000066] text-white text-sm font-bold rounded-xl transition-all shadow-sm cursor-pointer"
          >
                      ...
                      <div className="flex items-center justify-end gap-2">
                        {group.status === 'pending' ? (
                          <button 
                            ...
                            className="px-4 py-2 bg-[#000080] text-white text-xs font-bold rounded-xl hover:bg-[#000066] transition-all flex items-center gap-2 cursor-pointer"
                          >
                            Resolve Issue
                          ...
                          <button onClick={() => {
                            ...
                            className="px-4 py-2 bg-slate-100 text-slate-600 text-xs font-bold rounded-xl hover:bg-slate-200 transition-all flex items-center gap-2 cursor-pointer">
                            View Details
                          </button>
                        )}
                        <button 
                          onClick={() => setEditingFeedback(group.feedbacks[0])}
                          className="p-2 text-slate-400 hover:text-slate-600 rounded-lg hover:bg-slate-100 transition-all cursor-pointer"
                          title="Edit Feedback"
                        >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex flex-col gap-2">
                        <button 
                          onClick={() => window.location.href = `mailto:${selectedGroup.customerEmail}?subject=Regarding Your Feedback`}
                          className="flex items-center gap-3 p-3 rounded-xl bg-white border border-slate-100 hover:border-[#000080] hover:bg-[#000080]/5 text-sm font-bold text-slate-700 transition-all text-left cursor-pointer"
                        >
                        ...
                        <button 
                          onClick={() => window.location.href = `sms:${selectedGroup.customerEmail}`}
                          className="flex items-center gap-3 p-3 rounded-xl bg-white border border-slate-100 hover:border-[#000080] hover:bg-[#000080]/5 text-sm font-bold text-slate-700 transition-all text-left cursor-pointer"
                        >
            ...
            <motion.div
                    ...
                    <div className="flex items-center gap-2 h-[46px]">
                      {[1, 2, 3, 4, 5].map((s) => (
                        <button
                          ...
                          className={`p-1 transition-all cursor-pointer ${(newFeedback.rating || 5) >= s ? 'text-yellow-400' : 'text-slate-200'}`}
                        >
              ...
              <div className="p-6 bg-slate-50 border-t border-slate-100 flex items-center justify-end gap-4 shrink-0">
                <button 
                  type="button"
                  onClick={() => setIsAddingFeedback(false)}
                  className="px-6 py-3 text-slate-600 hover:text-slate-900 font-bold text-sm transition-all cursor-pointer"
                >
                  Cancel
                </button>
                <button 
                  ...
                  className="px-8 py-3 bg-[#000080] text-white font-bold rounded-xl hover:bg-[#000066] transition-all shadow-lg shadow-[#000080]/20 disabled:opacity-50 flex items-center gap-2 cursor-pointer"
                >
                  Save Feedback
                  <CheckCircle2 className="w-4 h-4" />
                </button>
