            ...
            <form onSubmit={onSubmit} className="mt-7 space-y-5">
              ...
              <div>
                <div className="mb-2 flex items-center justify-between gap-3">
                  <label htmlFor="workspace-email" className="block text-[11px] font-extrabold text-[#344054]">Email address</label>
                  {authMode === 'login' && <span className="text-[9px] font-extrabold uppercase tracking-wide text-[#000080]">Account email · ProFox sign-in</span>}
                </div>
