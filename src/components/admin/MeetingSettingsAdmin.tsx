      ...
      <main className="max-w-5xl mx-auto p-4 sm:p-8">
        <form onSubmit={save} className="space-y-6">
          ...
          <section className="bg-white border border-slate-200 rounded-2xl p-6 space-y-5 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Field label="Permitted Providers"><input value={form.providers.join(', ')} onChange={e => setForm({...form, providers:parseTextList(e.target.value)})} className={inputClass} /><p className="text-[11px] text-slate-400 mt-1">Manual must remain enabled. Google Calendar activation comes through the secure OAuth sub-job.</p></Field>
