  ...
  return <div className="min-h-screen bg-slate-50 text-slate-900">
    ...
    <main className="mx-auto max-w-7xl space-y-6 p-4 sm:p-8">
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-7">
        ...
        <div className="mt-5 rounded-2xl border border-blue-200 bg-blue-50 p-4 text-xs leading-5 text-blue-800"><strong>ProFox Calendar is primary.</strong> Google Calendar or Zoho Calendar can add external busy-time protection and synchronize this same CRM meeting. Google Meet or Zoho Meeting links are written back when the provider assigned to this person is connected and ready.</div>
