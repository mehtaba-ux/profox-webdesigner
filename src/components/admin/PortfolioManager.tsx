      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <button 
            ...
            className="flex items-center gap-2 text-slate-500 hover:text-slate-900 font-bold text-xs transition-colors py-2 px-1"
          >
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <button
                  ...
                  className="text-xs text-[#000080] hover:underline font-semibold flex items-center gap-1 cursor-pointer"
                >
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
          <div className="flex items-center gap-1 border-b border-slate-200 p-2 bg-slate-50/50 overflow-x-auto">
            ...
            <button onClick={() => setEditorTab('sidebar')}
              className={`px-4 py-2 rounded-lg text-xs font-bold transition-all flex items-center gap-2 whitespace-nowrap ${
            ...
            <button onClick={() => setEditorTab('results')}
              className={`px-4 py-2 rounded-lg text-xs font-bold transition-all flex items-center gap-2 whitespace-nowrap ${
            ...
            <button onClick={() => setEditorTab('testimonial')}
              className={`px-4 py-2 rounded-lg text-xs font-bold transition-all flex items-center gap-2 whitespace-nowrap ${
            ...
            <button onClick={() => setEditorTab('tech')}
              className={`px-4 py-2 rounded-lg text-xs font-bold transition-all flex items-center gap-2 whitespace-nowrap ${
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      className="w-full bg-white border border-slate-200 rounded-lg px-4 py-2 text-sm focus:border-[#000080] outline-none font-medium text-[#000080]"
                      placeholder="https://example.com"
                    />
                    <p className="text-[10px] text-slate-500 mt-1">If provided, a &quot;Visit Website&quot; button will appear on the case study page.</p>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-2xl max-w-3xl w-full shadow-2xl overflow-hidden border border-slate-200 flex flex-col max-h-[90vh]">
                            ...
                            <td className="px-4 py-3 text-right">
                              <div className="flex items-center justify-end gap-1">
                                <button 
                                  ...
                                  className="p-1.5 text-slate-400 hover:text-[#000080] hover:bg-slate-100 rounded-lg transition-colors cursor-pointer"
                                  title="Edit Category"
                                >
            ...
            <div className="p-4 border-t border-slate-200 bg-slate-50 flex justify-end">
              <button 
                ...
                className="px-5 py-2 bg-[#000080] hover:bg-[#000066] text-white font-bold rounded-xl text-xs shadow transition-all cursor-pointer"
              >
                Done
              </button>
            </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            type="button"
            onClick={() => setShowCategoryModal(true)}
            className="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold rounded-xl text-xs flex items-center gap-2 border border-slate-200 transition-all cursor-pointer shadow-sm"
          >
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-1.5">
                      ...
                      <ConfirmButton 
                        ...
                        confirmTitle="Delete Portfolio Item"
                        confirmMessage={`Are you sure you want to delete "${item.title}"? This cannot be undone.`}
