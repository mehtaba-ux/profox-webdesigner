...
const PagesManager = React.lazy(() => import('./PagesManager'));
const PortfolioManager = React.lazy(() => import('./PortfolioManager'));
const BlogManager = React.lazy(() => import('./BlogManager'));
const FeedbackManager = React.lazy(() => import('./FeedbackManager'));
const MediaManager = React.lazy(() => import('./MediaManager'));
const TemplateManager = React.lazy(() => import('./TemplateManager'));
const SiteSettingsManager = React.lazy(() => import('./SiteSettingsManager'));
const CustomMenuManager = React.lazy(() => import('./CustomMenuManager'));
const ImageUploader = React.lazy(() => import('./ImageUploader'));
const SalesChatInbox = React.lazy(() => import('./SalesChatInbox'));
const DevOnboarding = React.lazy(() => import('./DevOnboarding'));
const TeamManager = React.lazy(() => import('./TeamManager'));
const ProjectManager = React.lazy(() => import('./ProjectManager'));
const MyWorkDashboard = React.lazy(() => import('./MyWorkDashboard'));
const AwardsManager = React.lazy(() => import('./AwardsManager'));
const UserRoleManager = React.lazy(() => import('./UserRoleManager'));
const RecruitmentDashboard = React.lazy(() => import('./RecruitmentDashboard'));
const CRMLeads = React.lazy(() => import('./CRMLeads'));
const CRMPipeline = React.lazy(() => import('./CRMPipeline'));
const CRMActivities = React.lazy(() => import('./CRMActivities'));
const SalesCatalog = React.lazy(() => import('./SalesCatalog'));
const QuotationsManager = React.lazy(() => import('./QuotationsManager'));
const PaymentsManager = React.lazy(() => import('./PaymentsManager'));
const ClientsManager = React.lazy(() => import('./ClientsManager'));
const OnboardingManagement = React.lazy(() => import('./OnboardingManagement'));
const ConfigurationCenter = React.lazy(() => import('./ConfigurationCenter'));
const MyCommissions = React.lazy(() => import('./MyCommissions'));
const AdminCommissionManager = React.lazy(() => import('./AdminCommissionManager'));
const MyTraining = React.lazy(() => import('../onboarding/MyTraining'));
const TrainingLibrary = React.lazy(() => import('../onboarding/TrainingLibrary'));
