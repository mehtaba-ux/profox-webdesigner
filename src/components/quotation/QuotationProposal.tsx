...
function CustomerTimeline({ item }: { item: any }) {
  ...
  return <div className="mt-2 text-xs leading-5 text-slate-600">
    <p className="font-semibold text-[#000080]">{timeline}</p>
    {item?.durationNote && <p className="mt-0.5 text-[11px] text-slate-500">{item.durationNote}</p>}
  </div>;
}
