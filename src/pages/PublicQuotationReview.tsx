...
export default function PublicQuotationReview() {
  ...
  </div> : <div className="text-sm font-semibold text-slate-700">This quotation is currently <strong>{presentation?.status}</strong>. {presentation?.isSuperseded ? 'A newer revision is available; please use the latest ProFox proposal.' : 'Contact ProFox if you need an updated proposal.'}</div>;
