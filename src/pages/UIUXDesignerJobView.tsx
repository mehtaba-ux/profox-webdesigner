...
function Hero({ job }: { job: CareerJob }) {
  return (
    <section className="relative isolate h-[100svh] overflow-hidden bg-[#202126] text-white">
      <img
        src={IMAGES.hero}
      ...
      />
      <div className="absolute inset-0 -z-20 bg-gradient-to-r from-[#202126]/98 via-[#202126]/90 to-[#202126]/35" />
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_72%_28%,rgba(34,197,94,0.16),transparent_32%)]" />

      <div className="mx-auto grid h-full w-full max-w-6xl items-center gap-8 px-5 pb-8 pt-20 sm:px-6 sm:pt-24 lg:grid-cols-[1.06fr_.94fr]">
        <div className="max-w-3xl">
          <Link to="/careers" className="inline-flex items-center gap-2 text-[11px] font-medium text-slate-300 transition hover:text-white">
            <ArrowLeft className="h-3.5 w-3.5" /> Back to Careers
          </Link>
          <div className="mt-5 text-[10px] font-semibold uppercase tracking-[0.18em] text-emerald-400">Remote · Project-Based · Paid Per Project</div>
          <h1 className="mt-4 text-[clamp(2.35rem,5.6vw,4.55rem)] font-semibold leading-[0.98] tracking-[-0.055em]">
            Design real client experiences. <span className="text-emerald-400">Earn $1,500+–$3,000+</span> in monthly project potential.
          </h1>
          <p className="mt-5 max-w-2xl text-sm leading-6 text-slate-200 sm:text-[15px] sm:leading-7">
            Join ProFox as a UI/UX Designer and turn approved business requirements into clean, conversion-aware and accessible digital experiences. Start with paid project work and build toward bigger opportunities through consistent quality.
          </p>
          ...
          <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:items-center">
            <a href="#apply" className="inline-flex items-center justify-center gap-2 rounded-md bg-white px-5 py-3 text-sm font-semibold text-[#202126] transition hover:-translate-y-0.5 hover:bg-slate-100">
        ...
        <div className="hidden lg:flex lg:justify-end">
          <div className="w-full max-w-[340px] rounded-lg border border-white/10 bg-black/25 p-6 backdrop-blur-md">
            <div className="text-[10px] font-semibold uppercase tracking-[0.16em] text-emerald-400">Project-based earning potential</div>
            <div className="mt-3 text-4xl font-semibold tracking-[-0.04em]">$1,500+–$3,000+</div>
            <p className="mt-2 text-xs leading-6 text-slate-300">Per month potential based on available projects, scope, capacity and performance.</p>
...
function HeroPill({ icon: Icon, children }: { icon: any; children: string }) {
  return (
    <span className="inline-flex items-center gap-2 rounded-md border border-white/10 bg-black/25 px-3 py-2 text-[11px] font-medium text-white backdrop-blur">
